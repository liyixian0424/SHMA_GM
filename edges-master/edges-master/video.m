v = VideoReader('D:\WorkFiles\Edge_Based\TestBed\video\beam.mp4');
vdata = read(v);
vdata_selected = vdata(:,:,:,[240:5:720]);
targe_frame = [2:5:97];
r=10; %rearch radium
...
for kkk= 1:size(vdata_selected,4)
I = vdata_selected(:,:,:,kkk);
I1= impyramid(I, 'reduce'); %!!!!!! for pier5
I = I1;
...
ratio(kkk) = sum(length_line)/length_edge;

if ismember(kkk,targe_frame)
